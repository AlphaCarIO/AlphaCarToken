...
module.exports = function(deployer, network, accounts) {
  ...
  if (network == 'geth_dev') {
    ...
    deployer.deploy(AlphaCarToken, "ACAR", "0xbca685cb5dfd40658eabe435c56559915aa1b815", 
      {gas:5000000, gasPrice:50 * 10 ** 9, from: "0xbb65f9eb3a78ff3ebbc91e182ad9f3337b6329db"});
  } else {
    console.log("migrate others...")
    deployer.deploy(AlphaCarToken, "ACAR", "0xeF729e3e42c757e88aFB2C910C619b3aDf4472e6",
